...
EXTRACTIONS = [
    # Headers - all of them to understand the full architecture
    ("include/app.h", ["__FULL__"]),
    ("include/ui.h", ["__FULL__"]),
    ("include/renderer.h", ["__FULL__"]),
    ("include/input_handler.h", ["__FULL__"]),
    ("include/simulation.h", ["__FULL__"]),
    ("include/localization.h", ["__FULL__"]),
    ("include/pointer.h", ["__FULL__"]),
    ("include/star.h", ["__FULL__"]),
    ("include/compat.h", ["__FULL__"]),
    ("include/assets.h", ["__FULL__"]),

    # Source files - all of them
    ("src/app.cpp", ["__FULL__"]),
    ("src/ui.cpp", ["__FULL__"]),
    ("src/renderer.cpp", ["__FULL__"]),
    ("src/input_handler.cpp", ["__FULL__"]),
    ("src/simulation.cpp", ["__FULL__"]),
    ("src/main.cpp", ["__FULL__"]),
    ("src/star.cpp", ["__FULL__"]),
    ("src/assets.cpp", ["__FULL__"]),

    # Build config
    ("CMakeLists.txt", ["__FULL__"]),
]
